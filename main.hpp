...
void setupWindow() {
	...
	menu_window = glfwCreateWindow(menu_width, menu_height, "tyhlu.xyz External", NULL, NULL);
	if (menu_window == NULL) {
		return;
	}
	...
	my_image_texture = 0;
	//Replace "../../MyImage01.jpg" with your image path. Example: "C://Logo.png"
	Result = LoadTextureFromFile("C:\\Untitled-12.png", &my_image_texture, &my_image_width, &my_image_height);
	IM_ASSERT(Result);
